...
function EditCenter(props) {
  ...
  function handle(e) {
    ...
    newdata["center_id"] = CenterData.center_id
    setData(newdata)
    console.log(data)
  }
                    ...
                    <form onSubmit={(e) => submit(e)} method="HTTP_METHOD" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        <div class="form-group col-6">
                          ...
                          <input onChange={(e) => handle(e)} id="center_name" type="text" class="form-control" name="center_name" placeholder="e.g name" defaultValue={CenterData.center_name} />
                        </div>
                        <div class="form-group col-6">
                          <label for="">Address</label>
                          <input onChange={(e) => handle(e)} id="center_address" type="text" class="form-control" name="center_address" placeholder="e.g Raza" defaultValue={CenterData.center_address} />
                        </div>
                      </div>
                      <label className="badge badge-primary badge-shadow" style={{ padding: "8px" }}>Reservation info</label>
                      <div class="row">
                        <div class="form-group col-6">
                          <label for="">Reservation Capacity</label>
                          <input onChange={(e) => handle(e)} id="reservation_capacity" type="text" class="form-control" name="reservation_capacity" placeholder="e.g 0321-7171898" defaultValue={CenterData.reservation_capacity} />
                        </div>
                      </div>
